                              ...
                              children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.person,
                                      color: Color(0xFF009661), size: 22),
                                ),
                                ...
                                IconButton(
                                  icon: const Icon(Icons.lock_reset,
                                      color: Color(0xFF009661), size: 20),
    ...
    final faqs = [
      {
        ...
        'answer': 'Go to Settings > User Management > Add Helper. Enter a username and password for the helper account.'
      },
      {
        'question': 'How do I reset a helper\'s password?',
        'answer': 'Go to Settings > Manage Helpers and click the reset icon next to the helper\'s name.'
      },
      {
